...
|---|---|---|---|---|---|---|---|---|---|
| RISK-0001 | C1 | Technical | Prisma schema contains unused models (Task, Tour, Token) not tied to Jobnix features | Medium | Low | Low | REQ-0020 schema cleanup in C2; document in DECISION_LOG | Build Agent | Open |
